...
import 'package:iap/framework/data/model/audit_year.dart';

class AuditYearController extends GetxController{

   final Repositories repositories;
  AuditYearController({required this.repositories});
  ...
  Future<void> getList({required String path}) async{
    ...
    if(response.statusCode==200){
      _data=[];
      _data.addAll(AuditYear.fromJson(response.body).data);//should be more generic
      _isLoaded=true;
       update();
       print(_data.length);
    }
