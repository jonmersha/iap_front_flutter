...
import 'package:iap/framework/data/model/risk_level.dart';




class RiskLevelController extends GetxController{

   final Repositories repositories;
  RiskLevelController({required this.repositories});
  ...
  Future<void> getList({required String path}) async{
    ...
    if(response.statusCode==200){
      _data=[];
      _data.addAll(RiskLevel.fromJson(response.body).data);//should be more generic
      _isLoaded=true;
       update();
       print(_data.length);
    }
